...
(function(){
  ...
  var GCOLS = [
    ...
    { id: 'kream2026', y: '2026', ym: '2026-07',   // KREAM 단독 2026.7.9 11:00 ~ 7.31 23:59, 32,000원 (패스트페이퍼 2026.07.08 · 금강일보 2026.07.11)
      ...
      items: [
        { id: 'kream2026-geoje',    name: '거제 야호', price: 32000, date: '2026.07.09', parts: '원이의 고향 거제 · 섬과 모래성 손그림' },
        { id: 'kream2026-gyeongju', name: '경주 야호', price: 32000, date: '2026.07.09', parts: '제나의 고향 경주 · 첨성대와 경주빵 손그림' },
        { id: 'kream2026-suwon',    name: '수원 야호', price: 32000, date: '2026.07.09', parts: '리브의 고향 수원 · 수원 치킨 손그림' },
        { id: 'kream2026-chiba',    name: '치바 야호', price: 32000, date: '2026.07.09', parts: '미나미의 고향 치바 · 비행기와 나리타 공항 손그림' },
        { id: 'kream2026-goyang',   name: '고양 야호', price: 32000, date: '2026.07.09', parts: '메이의 고향 고양 · 고양시 마스코트와 물고기 손그림' }
      ] }
  ];
  ...
  function renderAllGoods(){
    ...
    GCOLS.forEach(function(c){
      h += '<div class="sec sec2"><div class="sec-t">' + c.y + '년 · ' + esc(c.title) + '<span class="cnt">' + c.items.length + '종</span></div></div>' + goodsGrid(c.items);
    });
