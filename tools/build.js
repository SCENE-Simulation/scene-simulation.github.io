...
rep('<div id="page-sim" hidden>',
  '<div id="page-sim" hidden>\n<div class="sec"><div class="sec-t"><svg viewBox="0 0 24 24"><use href="#i-gacha"/></svg>BREAD GACHA</div></div>\n' +
  '<p class="sec-d">빵 1개에 카드 1장, 카드는 27종입니다. 멤버 5명 × 4종 = 20종에 스페셜 7종을 더한 구성이며, 한 장이 나올 확률은 모두 1/27입니다.</p>');
rep('<div id="page-col">',
  '<div id="page-col">\n<div class="sec"><div class="sec-t"><svg viewBox="0 0 24 24"><use href="#i-book"/></svg>COLLECTION BOOK</div></div>\n' +
